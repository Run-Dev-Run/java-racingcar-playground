...
public class CarTest {
    ...
    private static final RandomNumber RANDOM_NUMBER_LESS_THAN_FOUR_OBJECT = new RandomNumber(3);
    ...
    void test_move(RandomNumber basicRandomNumber, Car expected) {
        car.move(basicRandomNumber);
